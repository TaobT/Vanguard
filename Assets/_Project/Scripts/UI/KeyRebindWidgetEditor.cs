...
{
    /// <summary>
    /// A custom inspector for <see cref="KeyRebindWidget"/> which provides a more convenient way for
    /// picking the binding which to rebind.
    /// </summary>
    [CustomEditor(typeof(KeyRebindWidget))]
    public class KeyRebindWidgetEditor : UnityEditor.Editor
    {
