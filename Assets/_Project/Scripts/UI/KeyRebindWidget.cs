...
namespace Vanguard.UI
{
    ...
    /// </summary>
    public class KeyRebindWidget : MonoBehaviour
    {
        /// <summary>
        ...
        {
            if (s_KeyRebindWidgets == null)
                s_KeyRebindWidgets = new List<KeyRebindWidget>();
            s_KeyRebindWidgets.Add(this);
            if (s_KeyRebindWidgets.Count == 1)
        ...
        protected void OnDisable()
        {
            ...
            s_KeyRebindWidgets.Remove(this);
            if (s_KeyRebindWidgets.Count == 0)
            {
                s_KeyRebindWidgets = null;
                InputSystem.onActionChange -= OnActionChange;
            }
        }
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            for (var i = 0; i < s_KeyRebindWidgets.Count; ++i)
            {
                var component = s_KeyRebindWidgets[i];
        ...
        private static List<KeyRebindWidget> s_KeyRebindWidgets;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<KeyRebindWidget, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<KeyRebindWidget, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
